...
describe('TextField', () => {
  ...
  it('should render textField', async () => {
    ...
    const textFieldDriver = new TextFieldDriver({
      component,
  ...
  describe('validation message', () => {
    ...
    it('should render validationMessage when input is requires after changing the input to empty string', async () => {
      const component = <TestCase value={''} validate={'required'} validationMessage={'mock message'} enableErrors validateOnChange />;
      const textFieldDriver = new TextFieldDriver({
        component,
        testID: TEXT_FIELD_TEST_ID
      });
  ...
  describe('validateOnBlur', () => {
    ...
    it('validate is called with defaultValue when defaultValue is given', async () => {
      ...
      const component = <TestCase validateOnBlur validationMessage={'Not valid'} validate={[validate]} defaultValue={defaultValue} />;
      const textFieldDriver = new TextFieldDriver({
        component,
        testID: TEXT_FIELD_TEST_ID
      });
